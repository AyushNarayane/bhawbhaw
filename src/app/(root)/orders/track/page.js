...
const OrderTrackingPage = () => {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-red-50 p-4 rounded-lg text-red-700">
          ...
          <p>{error}</p>
          <Link href="/orders" className="mt-4 inline-block text-red-600 hover:underline">
            Back to orders
          </Link>
        </div>
      </div>
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-yellow-50 p-4 rounded-lg text-yellow-700">
          ...
          <Link href="/orders" className="mt-4 inline-block text-yellow-600 hover:underline">
            Back to orders
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <Link href="/orders" className="text-red-600 hover:underline flex items-center">
